...
export const APP_MANIFESTS: AppManifest[] = [
  ...
  },
  {
    id: "myday",
    name: "Meu Dia",
    description: "Sugestões de tarefas do dia geradas por IA",
    icon: null as any,
  ...
  },
  {
    id: "templates",
    name: "Templates",
    description: "Modelos reusáveis para notas, docs, wiki e tarefas",
    icon: null as any,
    defaultSize: { width: 900, height: 640 },
    minSize: { width: 500, height: 400 },
    resizable: true,
  ...
  },
  {
    id: "snippets",
    name: "Snippets",
    description: "Texto expansível com triggers (ex: /meeting + espaço)",
    icon: null as any,
